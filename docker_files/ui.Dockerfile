...
# Google Chrome з .deb
RUN dpkg -i /app/docker_files/google-chrome-stable_114.0.5735.90-1_amd64.deb \
    && apt-get -f install -y
...
# docker run -v /home/den/hillel/aqa_python_80425/docker_scr:/app/screenshots/ selenium_test
# Виконуємо команду для запуску тестів під час створення контейнера
CMD ["pytest", "-m", "ui_test"]
